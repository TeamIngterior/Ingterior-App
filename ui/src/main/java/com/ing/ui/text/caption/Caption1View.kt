package com.ing.ui.text.caption

import android.content.Context
import android.graphics.Typeface
import android.util.AttributeSet
import androidx.core.content.ContextCompat
import com.ing.ui.Config.CAPTION1_FONT_SIZE
import com.ing.ui.Config.MEDIUM
import com.ing.ui.R
import com.ing.ui.text.BaseTextView

class Caption1View : BaseTextView {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        attrs?.let {
            ...
            val textColor = typedArray.getColor(R.styleable.BaseTextView_customTextColor, ContextCompat.getColor(context, R.color.text_color_04))
