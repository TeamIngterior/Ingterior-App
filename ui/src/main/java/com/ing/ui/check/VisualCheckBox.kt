...
class VisualCheckBox : LinearLayoutCompat {

    private var isChecked = false

    private val unCheckIcon = R.drawable.ic_uncheck_box
    private val unCheckBackground = R.drawable.bg_ing_uncheck_box
    private val unCheckTextColor = R.color.text_color_04

    private val checkIcon = R.drawable.ic_check_box
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        attrs?.let {
            val typedArray = context.obtainStyledAttributes(attrs, R.styleable.IngCheckBox, defStyleAttr, 0)
            val text = typedArray.getString(R.styleable.IngCheckBox_checkBoxText)

            isChecked = typedArray.getBoolean(R.styleable.IngCheckBox_isChecked, false)
            textView.text = text
            typedArray.recycle()
        }
